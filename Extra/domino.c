...
// Adicione peças à lista (substituindo essa parte com sua lógica de jogo)
// adicionarPeca(&mesa, pecas[0]);

// Mostre as peças na mesa
...
int main() {
    ...
    */  
    ...
    while (jogadorCampeaoDa1rodada == 0) {
        ...
        */
        printf("Player %d e %d venceram essa rodada", jogadorCampeaoDa1rodada, jogadorCampeaoDa1rodada+2); 
    }
